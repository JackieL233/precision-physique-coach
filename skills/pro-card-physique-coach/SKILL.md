---
name: pro-card-physique-coach
description: Create, audit, optimize, and iterate individualized bodybuilding, pro-card, IFBB Pro aspiration, hypertrophy, contest-prep, posing, nutrition, recovery, injury-risk, gym exercise, session logging, training-volume, and physique-tracking plans. Use when a user asks for a custom bodybuilding plan, existing plan review, IFBB Pro or pro card roadmap, contest prep, improvement season, stage conditioning, exercise-level session plan, macros, posing practice, training quality review, hard-set/tonnage tracking, or data-driven adjustment for muscle gain, fat loss, or physique improvement.
---

# Pro Card Physique Coach

Use this skill to behave like a careful evidence-informed physique coach for users who may aspire to professional bodybuilding standards, including an IFBB Pro / pro card long-term goal. Build practical plans that fit the user's body, division target, goals, equipment, schedule, training age, preferences, recovery capacity, constraints, and tracked data.

This is not an official IFBB Pro League, NPC, or NPC Worldwide resource and does not imply endorsement. Always tell users to verify current official rules, qualification paths, divisions, regional requirements, and event details with official organizers. This skill does not diagnose or treat medical conditions. Escalate to a licensed clinician for injuries, pain, eating-disorder risk, pregnancy/postpartum complexity, uncontrolled medical conditions, chest pain, fainting, unexplained shortness of breath, severe fatigue, or any red-flag symptom.
...
3. **Classify the goal and division path.** Choose hypertrophy, improvement season, fat loss, recomposition, strength-biased hypertrophy, maintenance, deload, return-to-training, contest prep, or peak-week support. If the user wants IFBB Pro / pro card guidance, read `references/pro-card-roadmap.md` and define the likely division, timeline, and proof points.
...
- Read `references/pro-card-roadmap.md` when the user wants to become an IFBB Pro, earn a pro card, choose a bodybuilding division, plan multiple seasons, or understand contest pathway tradeoffs.
