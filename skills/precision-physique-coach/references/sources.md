...
Use these sources as anchors when updating the skill. Prefer newer consensus statements, systematic reviews, and official organizations over influencer claims.
...
- Record date-sensitive changes in this file.
- Keep `SKILL.md` procedural and concise; place detailed source notes here or in domain references.
- Do not include unverified claims about supplements, injury treatment, or extreme contest-prep practices.
